...
import edu.eci.arsw.blueprints.persistence.impl.AnotherBlueprintsPersistence;
...
public class InMemoryPersistenceTest {
    ...
    public void getBlueprintsByAuthorTest() throws BlueprintPersistenceException, BlueprintNotFoundException {
        ...
        assertTrue("Loading a previously stored blueprint returned a different blueprint.", ibpp.getBlueprintsByAuthor(bp.getAuthor()).contains(bp));
